    ...
    <div class="flex items-center space-x-4 py-5 lg:py-6">
        ...
        <ul class="hidden flex-wrap items-center space-x-2 sm:flex">
            <li class="flex items-center space-x-2">
                <a class="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent" href="#">Management</a>
                    ...
                    <table class="is-hoverable w-full text-left">
                        ...
                        <template x-for="user in usersData" :key="user.id">
                            <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                                ...
                                <td  class="whitespace-nowrap px-3 py-3 font-medium text-slate-700 dark:text-navy-100 lg:px-5"> Nguyễn Văn Trọng</td>
                                <td  class="whitespace-nowrap px-4 py-3 sm:px-5"> 24-06-2003</td>
